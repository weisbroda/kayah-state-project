...
(NodeList.prototype.forEach = Array.prototype.forEach),
  (function () {
    var Masonry = function (gridElement, options) {
      (this.el = gridElement),
        (this.el.masonry = this),
        (this.options = options || {}),
        (this.childSelector =
          this.el.getAttribute("data-child-selector") || ""),
        (this.children = this.childSelector
          ? this.el.querySelectorAll(this.childSelector)
          : this.el.children),
        (this.filterSelector = ""),
        (this.filteredSelection = []),
        (this.filterButtonsWrapper = this.el.getAttribute("data-filter") || ""),
        (this.originalTransition = "transform .3s ease, opacity .3s ease"),
        (this.currentTransition = "0s"),
        (this.css3 = !0),
        (this.columns = parseInt(this.el.getAttribute("data-columns")) || 3),
        (this.gutter = parseInt(this.el.getAttribute("data-gutter")) || 0),
        (this.space =
          this.el.offsetWidth == document.body.clientWidth
            ? "around"
            : "between"),
        (this.cellRatio =
          eval(this.el.getAttribute("data-cell-ratio")) || 5 / 4),
        (this.mobileWidth =
          parseInt(this.el.getAttribute("data-mobile-width")) || 768),
        (this.colMinWidth =
          parseInt(this.el.getAttribute("data-col-min-width")) || 350),
        this.init();
    };
    (Masonry.prototype.init = function () {
      ...
      (this.el.style.position = "relative"),
        ...
        imagesLoaded(t.el, t.update.bind(t)),
        this.filterButtonsWrapper && this.initFilterButtons();
      var e;
      function i() {
        (t.currentTransition = "0s"),
          cancelAnimationFrame(e),
          (e = requestAnimationFrame(t.update.bind(t)));
      }
      window.addEventListener("resize", i);
      var r = document.createElement("iframe");
      (r.id = "resizeListener"),
        (r.style.cssText =
          "position:absolute;pointerEvents:none;opacity:0;height:0;border:0;width:100%;"),
        (r.onload = function () {
          r.contentWindow.addEventListener("resize", i);
        }),
        document.body.appendChild(r);
    }),
      (Masonry.prototype.update = function () {
        var t = this;
        t.gw = t.el.offsetWidth;
        var e = window.innerWidth > t.mobileWidth ? t.columns : 1;
        if (!t.options.gridMode) {
          var i = Math.floor(t.gw / t.colMinWidth) || 1;
          e = Math.min(i, e);
        }
        for (t.arr = []; e > 0; e--) t.arr.push(0);
        (t.gutterSum =
          (t.arr.length + ("around" == t.space ? 1 : -1)) * t.gutter),
          (t.iw = (t.gw - t.gutterSum) / t.arr.length);
        for (var r = 0; r < t.children.length; r++) {
          ...
          if (
            ...
            (n.style.transition = t.currentTransition),
            t.filteredSelection.length &&
              -1 === [].indexOf.call(t.filteredSelection, n))
          )
            (n.style.opacity = 0), (n.style.pointerEvents = "none");
          else {
            if (t.options.gridMode) {
              o = parseInt(n.getAttribute("data-w")) || 1;
              var a = parseInt(n.getAttribute("data-h")) || 1;
              if (
                (n.classList.contains("wide") && (o = 2),
                n.classList.contains("tall") && (a = 2),
                o > t.arr.length && (o = t.arr.length),
                o > 1)
              ) {
                s = [];
                for (var l = 0; l <= t.arr.length - o; l++) {
                  for (var h = [], c = l; c < l + o; c++) h.push(t.arr[c]);
                  s.push(Math.max.apply(null, h));
                }
              }
            }
            var d = Math.min.apply(null, s),
              u = s.indexOf(d),
              p = u * t.iw + (u + ("around" == t.space ? 1 : 0)) * t.gutter,
              f = d || "around" == t.space ? d + t.gutter : d;
            (n.style.width = o * t.iw + (o - 1) * t.gutter + "px"),
              t.options.gridMode &&
                (n.style.height =
                  (a * t.iw) / t.cellRatio + (a - 1) * t.gutter + "px"),
              (n.style.opacity = 1),
              (n.style.pointerEvents = "auto"),
              t.css3
                ? (n.style.transform =
                    "translate3d(" + p + "px, " + f + "px, 0)")
                : ((n.style.left = p + "px"), (n.style.top = f + "px"));
            for (l = u; l < u + o; l++)
              t.arr[l] = f + parseFloat(n.getBoundingClientRect().height);
          }
        }
        t.el.style.height =
          Math.max.apply(null, t.arr) +
          ("around" == t.space ? t.gutter : 0) +
          "px";
      }),
      (Masonry.prototype.filter = function (t) {
        (this.filterSelector = t),
          (this.filteredSelection =
            t && t.length > 1 ? this.el.querySelectorAll(t) : []),
          (this.currentTransition = this.originalTransition),
          this.update();
      }),
      (Masonry.prototype.initFilterButtons = function () {
        var t = this,
          e = document.querySelector(t.filterButtonsWrapper);
        e &&
          e.querySelectorAll("[data-filter]").forEach(function (i) {
            var r = i.getAttribute("data-filter");
            i.addEventListener("click", function (n) {
              if ((n.preventDefault(), !i.classList.contains("is-active"))) {
                var s = e.querySelector(".is-active");
      ...
      document.querySelectorAll(".grid").forEach(function (t) {
        new Masonry(t, { gridMode: !0 });
      }),
      document.querySelectorAll(".masonry").forEach(function (t) {
        new Masonry(t);
      });
  })();
 ...
 * Copyright 2018 AchtungThemes
 */
var Parallax = function (t, e) {
  (this.el = t),
    (this.el.parallaxInstance = this),
    (this.url =
      this.el.getAttribute("data-background") ||
      this.el.getAttribute("data-poster") ||
      window
        .getComputedStyle(this.el)
        .backgroundImage.slice(4, -1)
        .replace(/['"]/g, "")),
    (this.speed =
      parseFloat(this.el.getAttribute("data-parallax-speed")) || e || 0.2),
    this.init();
};
(Parallax.prototype.init = function () {
  (this.imgWrapper = document.createElement("div")),
    ...
    -1 ==
      ["absolute", "relative"].indexOf(
        window.getComputedStyle(this.el).position
      ) && (this.el.style.position = "relative"),
    (this.el.style.backgroundImage = "none"),
    (this.el.style.zIndex = 0),
    (this.imgWrapper.style.cssText =
      "position:absolute;pointer-events:none;z-index:-1;width:100%;height:100%;top:0;left:0;overflow:hidden;clip:rect(auto, auto, auto, auto);"),
    (this.img.style.cssText =
      "position:fixed;top:0;-webkit-backface-visibility:hidden;backface-visibility:hidden;will-change:transform;"),
    (this.img.style.background = "url(" + this.url + ") center/cover"),
    this.imgWrapper.insertBefore(this.img, this.imgWrapper.firstChild),
    this.el.insertBefore(this.imgWrapper, this.el.firstChild),
    this.setSize(),
    this.setPosition(),
    (this.raf = null),
  ...
  (Parallax.prototype.setPosition = function () {
    var t = this;
    cancelAnimationFrame(this.raf),
      (this.raf = requestAnimationFrame(function () {
        var e = t.imgWrapper.getBoundingClientRect();
        if (e.top < window.innerHeight && e.bottom > 0) {
          var i = e.top * t.speed;
          t.img.style.transform = "translate3d(0, " + i + "px, 0)";
        }
      }));
  }),
  (Parallax.prototype.setSize = function () {
    var t =
      (window.innerHeight - this.el.offsetHeight) * (1 - this.speed) +
      this.el.offsetHeight;
    (this.img.style.height = t + "px"),
      (this.img.style.width = this.el.offsetWidth + "px"),
      (this.img.style.left = this.el.getBoundingClientRect().left + "px"),
      this.setPosition();
  });
...
var buildElement = function (t) {
    var i = document.implementation.createHTMLDocument("");
    return (i.body.innerHTML = t), Array.from(i.body.children)[0];
  },
  triggerEvent = function (t, i) {
    var e = document.createEvent("HTMLEvents");
    e.initEvent(i, !0, !1), t.dispatchEvent(e);
  },
  PinchZoom = function (t, i) {
    (this.el = t),
      (this.zoomFactor = 1),
      (this.lastScale = 1),
      (this.offset = { x: 0, y: 0 }),
      (this.options = Object.assign({}, this.defaults, i)),
      this.setupMarkup(),
      this.bindEvents(),
      this.update(),
      this.enable();
...
PinchZoom.prototype = {
  ...
  handleDrag: function (t) {
    if (this.zoomFactor > 1) {
      ...
      this.drag(i, this.lastDragPosition),
        (this.offset = this.sanitizeOffset(this.offset)),
        (this.lastDragPosition = i);
    }
  },
  handleDragEnd: function () {
    triggerEvent(this.el, this.options.dragEndEventName), this.end();
  },
  ...
  handleZoom: function (t, i) {
    var e = this.getTouchCenter(this.getTouches(t)),
      n = i / this.lastScale;
    (this.lastScale = i),
      (this.nthZoom += 1),
      this.nthZoom > 3 && (this.scale(n, e), this.drag(e, this.lastZoomCenter)),
      (this.lastZoomCenter = e);
  },
  handleZoomEnd: function () {
    triggerEvent(this.el, this.options.zoomEndEventName), this.end();
  },
  handleDoubleTap: function (t) {
    var i = this.getTouches(t)[0],
      ...
      n = this.zoomFactor,
      o = function (t) {
        this.scaleTo(n + t * (e - n), i);
      }.bind(this);
    this.hasInteraction ||
      (n > e && (i = this.getCurrentZoomCenter()),
    ...
    i &&
      (this.options.lockDragAxis
        ? Math.abs(t.x - i.x) > Math.abs(t.y - i.y)
          ? this.addOffset({ x: -(t.x - i.x), y: 0 })
          : this.addOffset({ y: -(t.y - i.y), x: 0 })
        : this.addOffset({ y: -(t.y - i.y), x: -(t.x - i.x) }));
  },
  ...
  sanitizeOffsetAnimation: function () {
    var t = this.sanitizeOffset(this.offset),
      ...
      e = this.offset.y,
      n = function (n) {
        (this.offset.x = i + n * (t.x - i)),
          (this.offset.y = e + n * (t.y - e)),
          this.update();
      }.bind(this);
  ...
  getCurrentZoomCenter: function () {
    var t = this.container.offsetWidth * this.zoomFactor,
      i = this.offset.x,
      e = t - i - this.container.offsetWidth,
      n = i / e,
      o = (n * this.container.offsetWidth) / (n + 1),
      s = this.container.offsetHeight * this.zoomFactor,
      a = this.offset.y,
      r = s - a - this.container.offsetHeight,
      h = a / r,
      c = (h * this.container.offsetHeight) / (h + 1);
    return (
      0 === e && (o = this.container.offsetWidth),
      0 === r && (c = this.container.offsetHeight),
      { x: o, y: c }
    );
  },
  canDrag: function () {
  ...
  getTouches: function (t) {
    var i = this.container.getBoundingClientRect(),
      e = i.top + document.body.scrollTop,
      n = i.left + document.body.scrollLeft;
    return Array.prototype.slice.call(t.touches).map(function (t) {
      return { x: t.pageX - n, y: t.pageY - e };
    });
  },
  animate: function (t, i, e, n) {
        ...
        if (this.inAnimation) {
          ...
          a >= t
            ? (i(1),
              ...
              this.stopAnimation(),
              this.update())
            : (e && (r = e(r)), i(r), this.update(), requestAnimationFrame(s));
        }
      }.bind(this);
...
var detectGestures = function (t, i) {
  var e = null,
    n = 0,
    o = null,
    s = null,
    ...
    r = function (t) {
      2 === n ? a("zoom") : 1 === n && i.canDrag() ? a("drag", t) : a(null, t);
    },
    h = function (t) {
    ...
    c = function (t, i) {
      var e, n;
      return (e = t.x - i.x), (n = t.y - i.y), Math.sqrt(e * e + n * n);
    },
    f = function (t) {
  ...
  t.addEventListener("touchstart", function (t) {
    i.enabled &&
      ((l = !0),
      (n = t.touches.length) > 1 && f(t),
      (function (t) {
        var s = new Date().getTime();
        if ((n > 1 && (o = null), s - o < 300))
          switch (
            (setTimeout(function () {
              f(t);
            }),
    ...
    t.addEventListener("touchend", function (t) {
      i.enabled && ((n = t.touches.length), r(t));
    });
};
...
!(function (e) {
  (window.AGA = function (a, t) {
    var i = this;
    (this.data = []),
      (this.galleries = document.querySelectorAll(a)),
      (this.defaults = {
        thumbnails: !1,
        thumbnailsPinned: !1,
        idle: 5e3,
      ...
      void 0 !== t && (i.defaults = e.extend({}, i.defaults, t)),
    ...
    this.galleries.forEach(function (a, t) {
      ...
      document
        .querySelectorAll(i.defaults.singleSelector)
        .forEach(function (e) {
          var a = i.data.length,
            t = i.defaults;
          (t.thumbnails = !1),
    ...
    (AGA.prototype.init = function (a, t, i) {
      var o = this,
        ...
        s = n.length;
      (this.firstSlide = !0),
        (this.agaWrapper = e('<div class="aga-wrapper animating">')),
        (this.container = e('<div class="swiper-container">')),
        (this.wrapper = e('<div class="swiper-wrapper">')),
        (this.caption = e('<div class="aga-caption">')),
        (this.bottomBar = e('<div class="aga-bottombar">')),
        (this.topBar = e('<div class="aga-topbar">')),
        (this.counter = e('<div class="aga-counter">')),
        (this.zoomBtn = e('<div class="aga-zoom aga-btn">')),
        (this.fullscreenBtn = e('<div class="aga-fullscreen aga-btn">')),
        (this.closeBtn = e('<div class="aga-close aga-btn">')),
        n.forEach(function (a, i) {
          var n =
            ...
            (i == t ? "first" : "") +
            '">';
          a.src.match(/\.(jpe?g|png|gif)$/) ||
            (a.src.indexOf("youtube.com/") > -1
              ? (n =
                  '<iframe data-src="' +
                  a.src.replace("watch?v=", "embed/") +
                  (i == t ? "?autoplay=1" : "") +
                  '" frameborder="0" allowfullscreen></iframe>')
              : a.src.indexOf("vimeo.com/") > -1
              ? (n =
                  '<iframe data-src="https://player.vimeo.com/video/' +
                  a.src.split(".com/")[1] +
                  "?title=0&byline=0&portrait=0&transparent=0" +
                  (i == t ? "&autoplay=1" : "") +
                  '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>')
              : a.src.match(/\.(mp4|webm)$/) &&
                (n =
                  '<video data-src="' +
                  a.src +
                  ...
                  "></video>")),
            o.wrapper.append(
              e('<div class="swiper-slide loading">').append(
                e('<div class="slide-media">').append(n)
              )
            );
        }),
        i.customClass && o.agaWrapper.addClass(i.customClass),
        e("body").addClass("aga-wrapper-active"),
        e("body").append(
          o.agaWrapper.append(
            o.topBar.append(
              i.counter && s > 1 && o.counter,
              o.closeBtn,
              i.fullscreen && o.fullscreenBtn,
              i.zoom && !o.isTouch && o.zoomBtn
            ),
            o.container.append(o.wrapper),
            o.bottomBar.append(o.caption)
          )
        ),
        setTimeout(function () {
        ...
        s > 1 &&
          o.container.append(
            '<div class="aga-prev swiper-no-swiping"></div><div class="aga-next swiper-no-swiping"></div>'
          );
      var l = {
        initialSlide: t,
        spaceBetween: 10,
      ...
      if (
        (o.container.find(".aga-next").on("click", function () {
          u.slideNext(0);
        }),
        ...
        (l.on.slideChangeTransitionStart = function () {
          if (
            (o.counter.html("<span>" + (this.realIndex + 1) + "</span> / " + s),
            o.caption.html(n[this.realIndex].title),
            i.thumbnails &&
              (r
                .find(".swiper-slide")
                .removeClass("active")
                .eq(this.realIndex)
                .addClass("active"),
              r[0].swiper.slideTo(this.realIndex)),
            i.zoom)
          )
            if (o.isTouch) {
              var a = e(
                o.container[0].swiper.slides[
                  o.container[0].swiper.previousIndex
                ]
              ).find(".slide-media");
            ...
            l.length &&
              (l.on("load", function () {
                t.removeClass("loading").addClass("loaded"),
                  o.preload(),
                  i.zoom && !o.isTouch && o.zoomableCheck();
              }),
              l.attr("src", l.attr("data-src")).removeAttr("data-src"),
              "VIDEO" == l[0].tagName && l.trigger("load"));
          } else o.preload(), i.zoom && !o.isTouch && o.zoomableCheck();
        }),
        (l.on.init = l.on.slideChangeTransitionStart),
        i.thumbnails)
      ) {
        ...
        n.forEach(function (a) {
          var t = a.thumb || "";
          d.append(
            e('<div class="swiper-slide">').append(
              e(
                '<div class="aga-thumb" style="background-image: url(' +
                  t +
                  ')">'
              )
            )
      ...
      i.zoom &&
        (o.isTouch
          ? o.wrapper.find("img").each(function () {
              var a = e(this).closest(".slide-media"),
                t = new PinchZoom(a[0], {});
              (a[0].pz = t),
                e(window).on("resize.agaMobileZoom", function () {
                  o.resetMobileZoom(a);
                });
            })
          : (o.zoomBtn.on("click", o.toggleZoom.bind(o)),
            o.wrapper.on("click", "img", function (e) {
              o.agaWrapper.hasClass("has-zoomable-img") &&
                o.toggleZoom.call(o, e);
            })));
      var u = new Swiper(o.container[0], l);
      o.wrapper.add(o.closeBtn).on("click", o.close.bind(o)),
        e(document).on("keyup.agalb", function (e) {
          27 == e.keyCode && o.close.call(o);
        }),
        o.wrapper.on("click", ".slide-media > *", function (e) {
          e.stopPropagation();
        }),
        !o.isTouch && i.idle && o.idle(i.idle),
        o.isTouch &&
          o.wrapper.on("click", "img", function (e) {
            o.agaWrapper.toggleClass("aga-idle");
          }),
        i.fullscreen && o.fullscreenBtn.on("click", o.toggleFullscreen.bind(o)),
        i.zoom &&
          !o.isTouch &&
          e(window).on("resize.agalb", o.zoomableCheck.bind(o));
    }),
    (AGA.prototype.preload = function () {
      e(
        ".swiper-slide-next:not(.loaded) [data-src], .swiper-slide-prev:not(.loaded) [data-src]"
      ).each(function () {
        var a = e(this);
        a.on("load", function () {
          ...
          "VIDEO" == a[0].tagName && a.trigger("load");
      }),
        (this.firstSlide = !1);
    }),
    (AGA.prototype.zoomableCheck = function () {
      var e = this.agaWrapper.find(".swiper-slide-active .slide-media img"),
        a =
          e.length &&
          (e[0].naturalWidth > this.container.width() ||
            e[0].naturalHeight > this.container.height()),
    ...
    (AGA.prototype.zoomIn = function (a) {
      var t = e(
          this.container[0].swiper.slides[this.container[0].swiper.activeIndex]
        ),
        i = t.find(".slide-media"),
        o = t.find("img");
      e(window).on("resize.agaZoom", this.zoomOut.bind(this)),
        t.addClass("is-zoomed"),
        o.addClass("swiper-no-swiping zoomed"),
        this.agaWrapper.addClass("has-zoomed-img");
      ...
      var s = this.container.width() / 2 + this.container.offset().left,
        ...
        r =
          (o[0].naturalWidth - this.container.width()) / this.container.width();
      r < 0 && (r = 0);
      var c =
        (o[0].naturalHeight - this.container.height()) /
        this.container.height();
      if (
        (c < 0 && (c = 0),
        e(document).on("mousemove.agaZoom", function (e) {
          var a = (s - e.pageX) * r,
            t = (l - e.pageY) * c;
    ...
    (AGA.prototype.zoomOut = function () {
      ...
      if (a.length) {
        ...
        t.addClass("transition"),
          ...
          t.removeAttr("style"),
          i.removeAttr("style").one("transitionend", function () {
            i.removeClass("swiper-no-swiping zoomed").off(".agaZoom");
          }),
          e(window).off(".agaZoom"),
          e(document).off(".agaZoom"),
          this.agaWrapper.removeClass("has-zoomed-img"),
          a.removeClass("is-zoomed");
      }
    }),
    (AGA.prototype.toggleZoom = function (a) {
      e(".swiper-slide-active img").hasClass("zoomed")
        ? this.zoomOut.call(this)
        : this.zoomIn.call(this, a);
    }),
    (AGA.prototype.resetMobileZoom = function (e) {
      var a = e[0].pz;
      a && ((a.zoomFactor = 1), (a.offset = { x: 0, y: 0 }), a.update());
    }),
    (AGA.prototype.idle = function (a) {
      var t = this;
      (t.idleTimeout = null),
        e(document).on(
          "mousemove.agalb keydown.agalb touchstart.agalb click.agalb wheel.agalb",
          i
        );
      function i() {
        clearTimeout(t.idleTimeout),
          t.agaWrapper.removeClass("aga-idle"),
    ...
    (AGA.prototype.exitFullscreen = function () {
      document.exitFullscreen
        ...
        this.agaWrapper.removeClass("fullscreen");
    }),
    (AGA.prototype.requestFullscreen = function () {
      ...
      e.requestFullscreen
        ...
        this.agaWrapper.addClass("fullscreen");
    }),
    ...
    (AGA.prototype.close = function () {
      ...
      a.agaWrapper.addClass("animating").one("transitionend", function () {
        ...
        e("body").removeClass("aga-wrapper-active"),
        e(window).off(".agaMobileZoom .agalb .agaZoom"),
        e(document).off(".agalb .agaZoom"),
 ...
 */
!(function ($) {
  ($.fn.elData = function (e, t) {
    var a = this.data(e);
    return void 0 != a && "" != this.attr("data-" + e) ? a : t;
  }),
    (window.raf = function (e, t) {
      var a;
    ...
    (window.ScrollListener = function (e, t) {
      var a = this;
      if (
        (t.navigation &&
          ((this.navItems = {}),
          (e = [].map
            .call(document.querySelectorAll(e), function (e) {
              var t = e.getAttribute("href");
              return !t.match(/^#.+/) || ((a.navItems[t] = e), t);
            })
            .join(","))),
        e && "string" == typeof e)
      )
        this.nodes = document.querySelectorAll(e);
      else if (e instanceof Element) this.nodes = [e];
      else {
        if (!(e instanceof NodeList)) return;
        this.nodes = e;
      }
      (this.defaults = {
        offsetTop: 0,
      ...
      this.options.onDisappear && (this.options.once = !1),
        (this.sequenceTimeout = null),
        (this.sequenceArray = []),
        (this.options.onAppear || this.options.onDisappear) &&
          [].forEach.call(a.nodes, function (e) {
            a.listenTo(e);
          }),
        (this.options.active || this.options.navigation) && this.activeCheck();
    }),
    (ScrollListener.prototype.listenTo = function (e) {
      var t = this,
        a = !1,
        o = null,
        i = function () {
          cancelAnimationFrame(o),
            (o = requestAnimationFrame(function () {
              ...
              o.top < window.innerHeight - t.options.offsetBottom &&
              o.bottom > t.options.offsetTop
                ? (t.options.once && window.removeEventListener("scroll", i),
                  t.options.onAppear &&
                    !a &&
                    (t.options.sequenceDelay
                      ? (t.sequenceArray.push(e),
                        clearTimeout(t.sequenceTimeout),
                        (t.sequenceTimeout = setTimeout(function () {
                          t.sequenceArray.forEach(function (e, a) {
                            setTimeout(function () {
                              t.options.onAppear.call(e);
                            }, t.options.sequenceDelay * a);
                          }),
                            (t.sequenceArray = []);
                        }, 100)))
                      : t.options.onAppear.call(e)),
                  (a = !0))
                : a &&
                  (t.options.onDisappear && t.options.onDisappear.call(e),
                  (a = !1));
            }));
        };
      i(), window.addEventListener("scroll", i);
    }),
    (ScrollListener.prototype.activeCheck = function () {
      var e = this,
        t = [],
        a = null,
        o = function () {
          t = [];
          for (var o = 0, i = e.nodes.length; o < i; o++) {
            var n = e.nodes[o];
            if (!(n.getBoundingClientRect().top < window.innerHeight / 2))
              break;
            t.push(n);
          }
          var s = t[t.length - 1];
          a != s &&
            (e.options.active && e.options.active.call(s),
            e.options.navigation &&
              (a && e.navItems["#" + a.id].classList.remove("active"),
              e.navItems["#" + s.id].classList.add("active")),
            (a = s));
        };
    ...
    (function () {
      if (document.body.classList.contains("sticky-header")) {
        ...
        raf("scroll", function () {
          var t =
              e > 150 &&
              e + window.innerHeight < document.body.scrollHeight - 150,
            a = window.pageYOffset > e;
          t
            ? a
              ? (document.body.classList.add("scrolling-down"),
                (e = window.pageYOffset))
              : e - window.pageYOffset > 30 &&
    ...
    [].forEach.call(
      ...
      function (e) {
        if (!e.classList.contains("background-parallax")) {
          var t =
            e.getAttribute("data-background") || e.getAttribute("data-poster");
          t &&
            (t.match("^rgb") || t.match("^#")
    ...
    document.querySelectorAll("[data-overlay]").forEach(function (e) {
      var t = e.getAttribute("data-overlay"),
        a = (t && t.split(";")[0]) || "#000",
        o = (t && t.split(";")[1]) || 0.5,
        i = document.createElement("div");
      i.classList.add("content-overlay"),
    ...
    (window.Appear = {
      init: function () {
        document.querySelectorAll("[data-animation]").forEach(function (e) {
          $(e).closest(".swiper-slide").length ||
            ((e.style.animation = e.getAttribute("data-animation") + " both"),
            isNaN(parseInt(e.style.animationDuration)) &&
    ...
    document.querySelectorAll(".reveal-sections-wrapper").forEach(function (e) {
      e.querySelectorAll(".reveal-section").forEach(function (e, t) {
        if (0 != t) {
          var a = e.querySelector(".reveal-section-inner");
          raf("scroll", function () {
            var t = e.getBoundingClientRect().top;
            t < window.innerHeight && t > 0
              ? (e.classList.add("is-fixed"),
                (a.style.opacity = 1 - t / window.innerHeight))
              : (e.classList.remove("is-fixed"), (a.style.opacity = 1));
          });
        }
      });
    }),
    $(".thumbnail-video").each(function () {
      var e,
        ...
        a = $(this),
        o = a.attr("data-src");
      o.indexOf("youtube.com/") > -1
        ? ((t = o.split("watch?v=")[1]),
          (e =
            '<iframe src="https://www.youtube.com/embed/' +
            t +
            '?autoplay=1" frameborder="0" allowfullscreen></iframe>'))
        : o.indexOf("vimeo.com/") > -1
        ? ((t = o.split(".com/")[1]),
          (e =
            '<iframe src="https://player.vimeo.com/video/' +
            t +
            '?autoplay=1&title=0&byline=0&portrait=0&transparent=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'))
        : (e = '<video src="' + o + '" autoplay controls></video>'),
        a.one("click", function () {
          a.append(e),
            setTimeout(function () {
              a.addClass("has-started");
            }, 50);
        });
    }),
    $(".video-background").each(function () {
      ...
      if (!(window.innerWidth < 1025)) {
        ...
        var loop = self.elData("loop", !0) ? 1 : 0,
          autoplay =
            self.elData("autoplay", !1) &&
            !self.closest(".swiper-slide").length,
          controls = [
            "play",
            "progress",
            "current-time",
        ...
        self.elData("controls", !1) || (controls = []),
          self.elData("play-icon", !0) && controls.push("play-large");
        var src = self.attr("data-src"),
          type = "";
        src &&
          (src.indexOf("youtube.com/") > -1
            ? (type = "youtube")
            : src.indexOf("vimeo.com/") > -1 && (type = "vimeo"),
          type
            ? (self.attr("data-type", type), self.attr("data-video-id", src))
            : (self[0].src = src));
        ...
        (self[0].videoPlayer = player[0]),
          player[0] &&
            player[0].on("ready", function () {
              var wrapper = $(player[0].getContainer());
              wrapper.addClass("video-bg-wrapper"),
                wrapper.find(".plyr__controls").addClass("noswipe"),
                player[0].setVolume(volume),
                autoplay && player[0].play(),
                loop &&
              ...
              if (
                ...
                function makeVideoCover() {
                  var e = wrapper.width() / wrapper.height(),
                    t = vr > e ? vr / e : e / vr;
                  video.css({
                    transform: "translate3d(-50%, -50%, 0) scale(" + t + ")",
                  });
                }
                window.raf("resize", makeVideoCover),
                  setTimeout(makeVideoCover, 1500);
              }
            });
      }
    }),
    $(".swiper").each(function () {
      var e = $(this),
        t = e.elData("loop", !1) && !e.find(".video-background").length;
      e.addClass("swiper-container"),
        e.wrapInner('<div class="swiper-wrapper">'),
        e.elData("nav", !1) &&
          e.append(
            '<div class="swiper-prev noswipe"></div><div class="swiper-next noswipe"></div>'
          ),
        e.elData("pagination", !1) &&
          e.append('<div class="swiper-pagination noswipe">'),
        e.elData("scrollbar", !1) && e.append('<div class="swiper-scrollbar">');
      var a = {
        speed: 600,
        autoplay: !1,
        loop: t,
      ...
      $.extend(a, e.data()),
        ...
        (a.pagination = { el: e.find(".swiper-pagination")[0], clickable: !0 }),
        (a.scrollbar = {
      ...
      var o = void 0 != a.spaceTablet ? a.spaceTablet : a.spaceBetween,
        i = void 0 != a.spaceMobile ? a.spaceMobile : o;
      (a.breakpoints = {
        768: {
          slidesPerView: a.slidesMobile || a.slidesTablet || a.slidesPerView,
          spaceBetween: i,
        },
        1024: {
          slidesPerView: a.slidesTablet || a.slidesPerView,
          spaceBetween: o,
        },
      }),
        e.find(".video-background").length &&
          ((a.on.slideChangeTransitionStart = function () {
            var t = e.find(".plyr--playing");
            t.length && t.find(".video-background")[0].videoPlayer.pause();
          }),
          (a.on.slideChangeTransitionEnd = function () {
            var t = e.find(
              '.swiper-slide-active .plyr .video-background[data-autoplay="true"]'
            );
            t.length && t[0].videoPlayer.play();
          }),
          (a.on.init = a.on.slideChangeTransitionEnd)),
        e.find(".lightbox-link:not(.overlay)").each(function () {
    ...
    $(window).on("load", function () {
      $(".swiper[data-sync]").each(function () {
        var e = $(this),
          t = e[0].swiper,
          a = e.data("sync"),
          o = $('.swiper[data-swiper-name="' + a + '"]');
        a && o.length && (t.controller.control = o[0].swiper);
      });
    }),
    $(".justified").each(function () {
      var e = $(this),
        t = e.data("target-height") || 400,
        a = e.data("gutter") || 0;
      e.css({
        padding: a + "px " + a + "px 0",
        position: "relative",
    ...
    [].forEach.call(
      ...
      function (e) {
        var t = e.getAttribute("data-scroll-speed") || 1e3,
          a = e.getAttribute("data-scroll-offset") || 0,
          o = document.querySelector(e.getAttribute("href"));
        e.addEventListener("click", function (e) {
          e.preventDefault();
          var i = window.scrollY + o.getBoundingClientRect().top - a;
          $("html, body").animate({ scrollTop: i }, t, "easeInOutExpo");
        });
      }
    ),
    $(".mail-form").submit(function (e) {
      ...
      if (t[0].checkValidity()) {
        var a = { items: {} };
        t.data("mailto") && (a.mailto = t.data("mailto")),
          t.data("subject") && (a.subject = t.data("subject"));
        var o = [];
          ...
          if (!(o.indexOf(e) > -1)) {
            ...
            null !== t &&
              ...
              ("radio" == $(this).attr("type") &&
                (t = $("[name=" + e + "]:checked").val()),
              "checkbox" == $(this).attr("type") &&
                (t = $(this).prop("checked") ? "Yes" : "No"),
              "object" == typeof t && (t = t.join("; ")),
              (a.items[e] = t),
              ["name", "email", "subject"].indexOf(e) > -1 && (a[e] = t),
              o.push(e));
          }
        }),
          $.ajax({
            ...
            success: function (e) {
              $(".mail-form-message")
                ...
                .slideDown(500),
                -1 == e.indexOf("error") &&
                  t.find("[name]:not([type=radio])").val("");
            },
            error: function () {
              $(".mail-form-message")
                .removeClass("d-none")
                .html('<p class="error">Something went wrong, try again!</p>')
                .slideDown("slow");
            },
          });
      } else $(".mail-form-message").html('<p class="error">Please fill out required fields!</p>').slideDown("slow");
    });
  var gmaps_api_key = $(".google-map[data-api-key]:first").data("api-key");
  gmaps_api_key &&
    $("body").append(
      '<script src="https://maps.googleapis.com/maps/api/js?key=' +
        gmaps_api_key +
        '&callback=initMaps"></script>'
    ),
    (window.initMaps = function () {
      $(".google-map").each(function () {
        var e = $(this);
        e.addClass("ready");
        var t = e.data("latitude") || 51.5255069,
          a = e.data("longitude") || -0.0836207,
          o = e.data("zoom") || 14,
          i = e.data("marker") || "img/map-marker.png",
          n = e.find(".map-pin"),
          s = {
        ...
        "none" != i &&
          ...
          n.each(function () {
            var e = $(this),
              o = e.data("latitude") || t,
              i = e.data("longitude") || a,
              n = e.data("marker") || "img/map-marker.png";
            new google.maps.Marker({
              position: new google.maps.LatLng(o, i),
              map: r,
              visible: !0,
              icon: n,
            });
